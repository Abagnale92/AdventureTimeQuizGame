...
namespace Adventure_Time_Quiz
{
    ...
    /// </summary>
    public sealed partial class Indovina : Page
    {
        ...
        private async void HardwareButtons_BackPressed(object sender, BackPressedEventArgs e)
        {
            ...
            {
                // dt.Stop();
                this.Frame.Navigate(typeof(Middlepage));
        ...
        private void Page_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            if (dbchisei == "ita")
            {
                loadedCustomData = XDocument.Load("indovina.xml");
            }
            else
            {

                loadedCustomData = XDocument.Load("indovinaeng.xml");
            }
            ...
            var immagine = from c in loadedCustomData.Descendants("Domanda")
                           ...
                           select c.Attribute("Immagine").Value;
            source = immagine.First();
            img.Source = new BitmapImage(new Uri(this.BaseUri, source));
